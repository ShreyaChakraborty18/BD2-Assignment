...
function sortHotelsPrices(hotel1, hotel2, pricing) {
...
app.get('/hotels/sort/pricing', (req, res) => {
  ...
  let results = hotelsCopy.sort((hotel1, hotel2) =>
    sortHotelsPrices(hotel1, hotel2, pricing)
  );
  res.json(results);
});

function sortHotelsRatings(hotel1, hotel2, rating) {
...
app.get('/hotels/sort/rating', (req, res) => {
  ...
  let hotelsCopy = hotels.slice();
  let results = hotelsCopy.sort((hotel1, hotel2) =>
    sortHotelsRatings(hotel1, hotel2, rating)
  );
  res.json(results);
});

function sortHotelsReviews(hotel1, hotel2, reviews) {
...
app.get('/hotels/sort/reviews', (req, res) => {
  ...
  let hotelsCopy = hotels.slice();
  let results = hotelsCopy.sort((hotel1, hotel2) =>
    sortHotelsReviews(hotel1, hotel2, reviews)
  );
  res.json(results);
});
